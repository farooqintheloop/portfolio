...
const ProjectsSection = () => {
  const projects = [
    ...
    },
    {
      ...
      github: 'https://github.com/farooqintheloop/LMS'
    },
    {
      ...
      github: 'https://github.com/farooqintheloop/Foodler'
    },
    {
      title: 'Dependency Visualizer – Interactive Dependency & Security Analysis Tool',
      description: 'Full-stack developer tool that transforms package.json files into interactive dependency graphs, providing real-time dependency analysis, vulnerability detection, security insights, and project health metrics using Next.js, React Flow, and TypeScript.',
      tags: ['Next.js', 'React', 'TypeScript', 'React Flow', 'Tailwind CSS', 'npm Audit'],
      image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=80&w=2070&auto=format&fit=crop',
      github: 'https://github.com/farooqintheloop/Dependency-Visualizer'
    }
  ];
